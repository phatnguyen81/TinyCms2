...
namespace TinyCms.Core.Plugins
{
    ...
    public class PluginFinder : IPluginFinder
    {
        ...
        /// <returns>true - available; false - no</returns>
        public virtual bool AuthenticateStore(PluginDescriptor pluginDescriptor)
        {
            if (pluginDescriptor == null)
                throw new ArgumentNullException("pluginDescriptor");
            ...
            int storeId = 0, string group = null)
        {
            ...
            return _plugins.Where(p => CheckLoadMode(p, loadMode) && AuthenticateStore(p) && CheckGroup(p, group));
        }
