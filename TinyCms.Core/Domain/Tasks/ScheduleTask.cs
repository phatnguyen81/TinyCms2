...
namespace TinyCms.Core.Domain.Tasks
{
    ...
    public class ScheduleTask : BaseEntity
    {
        ...
        /// <summary>
        ///     Gets or sets the machine name (instance) that leased this task. It's used when running in web farm (ensure that a
        ///     task in run only on one machine). It could be null when not running in web farm.
        /// </summary>
        public string LeasedByMachineName { get; set; }

        /// <summary>
        ///     Gets or sets the datetime until the task is leased by some machine (instance). It's used when running in web farm
        ///     (ensure that a task in run only on one machine).
        /// </summary>
