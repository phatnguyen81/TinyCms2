...
+function(t) {
        ...
        "use strict";
        var e = function(i, n) { this.$element = t(i), this.options = t.extend({}, e.DEFAULTS, n) };
        e.DEFAULTS = { loadingText: "loading..." }, e.prototype.setState = function(t) {
            ...
            t += "Text", o.resetText || i.data("resetText", i[n]()), i[n](o[t] || this.options[t]), setTimeout(function() { "loadingText" == t ? i.addClass(e).attr(e, e) : i.removeClass(e).removeAttr(e) }, 0);
        ...
        e.DEFAULTS = { interval: 5e3, pause: "hover", wrap: !0 }, e.prototype.cycle = function(e) { return e || (this.paused = !1), this.interval && clearInterval(this.interval), this.options.interval && !this.paused && (this.interval = setInterval(t.proxy(this.next, this), this.options.interval)), this }, e.prototype.getActiveIndex = function() { return this.$active = this.$element.find(".item.active"), this.$items = this.$active.parent().children(), this.$items.index(this.$active) }, e.prototype.to = function(e) {
            ...
            return e > this.$items.length - 1 || 0 > e ? void 0 : this.sliding ? this.$element.one("slid", function() { i.to(e) }) : n == e ? this.pause().cycle() : this.slide(e > n ? "next" : "prev", t(this.$items[e]));
            ...
            if (!o.hasClass("active")) {
                if (this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$element.one("slid", function() {
                    ...
                    o.addClass(e), o[0].offsetWidth, n.addClass(a), o.addClass(a), n.one(t.support.transition.end, function() { o.removeClass([e, a].join(" ")).addClass("active"), n.removeClass(["active", a].join(" ")), l.sliding = !1, setTimeout(function() { l.$element.trigger("slid") }, 0) }).emulateTransitionEnd(600);
                } else {
                    if (this.$element.trigger(h), h.isDefaultPrevented())return;
        ...
        "use strict";
        var e = function(i, n) { this.$element = t(i), this.options = t.extend({}, e.DEFAULTS, n), this.transitioning = null, this.options.parent && (this.$parent = t(this.options.parent)), this.options.toggle && this.toggle() };
        e.DEFAULTS = { toggle: !0 }, e.prototype.dimension = function() {
            ...
            if (!this.transitioning && !this.$element.hasClass("in")) {
                ...
                if (this.$element.trigger(e), !e.isDefaultPrevented()) {
                    ...
                    var s = function() { this.$element.removeClass("collapsing").addClass("in")[o]("auto"), this.transitioning = 0, this.$element.trigger("shown.bs.collapse") };
        ...
        var n = ".dropdown-backdrop", o = "[data-toggle=dropdown]", s = function(e) { t(e).on("click.bs.dropdown", this.toggle) };
        ...
        }, t.fn.dropdown.Constructor = s, t.fn.dropdown.noConflict = function() { return t.fn.dropdown = a, this }, t(document).on("click.bs.dropdown.data-api", e).on("click.bs.dropdown.data-api", ".dropdown form", function(t) { t.stopPropagation() }).on("click.bs.dropdown.data-api", o, s.prototype.toggle).on("keydown.bs.dropdown.data-api", o + ", [role=menu]", s.prototype.keydown);
    }(window.jQuery), +function(t) {
        "use strict";
        ...
        e.DEFAULTS = { backdrop: !0, keyboard: !0, show: !0 }, e.prototype.toggle = function(t) { return this[this.isShown ? "hide" : "show"](t) }, e.prototype.show = function(e) {
            ...
            this.$element.trigger(n), this.isShown || n.isDefaultPrevented() || (this.isShown = !0, this.escape(), this.$element.on("click.dismiss.modal", "[data-dismiss=\"modal\"]", t.proxy(this.hide, this)), this.backdrop(function() {
                ...
                n ? i.$element.find(".modal-dialog").one(t.support.transition.end, function() { i.$element.focus().trigger(o) }).emulateTransitionEnd(300) : i.$element.focus().trigger(o);
            }));
        ...
        t.fn.modal = function(i, n) {
            ...
            e.preventDefault(), o.modal(s, this).one("hide", function() { i.is(":visible") && i.focus() });
        ...
        e.DEFAULTS = { animation: !0, placement: "top", selector: !1, template: "<div class=\"tooltip\"><div class=\"tooltip-arrow\"></div><div class=\"tooltip-inner\"></div></div>", trigger: "hover focus", title: "", delay: 0, html: !1, container: !1 }, e.prototype.init = function(e, i, n) {
            ...
            return clearTimeout(i.timeout), i.hoverState = "in", i.options.delay && i.options.delay.show ? void(i.timeout = setTimeout(function() { "in" == i.hoverState && i.show() }, i.options.delay.show)) : i.show();
        }, e.prototype.leave = function(e) {
            var i = e instanceof this.constructor ? e : t(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type);
            return clearTimeout(i.timeout), i.hoverState = "out", i.options.delay && i.options.delay.hide ? void(i.timeout = setTimeout(function() { "out" == i.hoverState && i.hide() }, i.options.delay.hide)) : i.hide();
        }, e.prototype.show = function() {
            ...
            function e() { "in" != i.hoverState && n.detach() }
        ...
        }, e.prototype.getCalculatedOffset = function(t, e, i, n) { return"bottom" == t ? { top: e.top + e.height, left: e.left + e.width / 2 - i / 2 } : "top" == t ? { top: e.top - n, left: e.left + e.width / 2 - i / 2 } : "left" == t ? { top: e.top + e.height / 2 - n / 2, left: e.left - i } : { top: e.top + e.height / 2 - n / 2, left: e.left + e.width } }, e.prototype.getTitle = function() {
        ...
        e.prototype.show = function() {
            ...
            if (n || (n = e.attr("href"), n = n && n.replace(/.*(?=#[^\s]*$)/, "")), !e.parent("li").hasClass("active")) {
                ...
                if (e.trigger(s), !s.isDefaultPrevented()) {
                    var a = t(n);
                    this.activate(e.parent("li"), i), this.activate(a, a.parent(), function() { e.trigger({ type: "shown.bs.tab", relatedTarget: o }) });
                }
            }
        ...
        "use strict";
        var e = function(i, n) { this.options = t.extend({}, e.DEFAULTS, n), this.$window = t(window).on("scroll.bs.affix.data-api", t.proxy(this.checkPosition, this)).on("click.bs.affix.data-api", t.proxy(this.checkPositionWithEventLoop, this)), this.$element = t(i), this.affixed = this.unpin = null, this.checkPosition() };
 ...
 */
    function(t, e) {
        ...
        function e(t, e) { return b.call(t, e) }

        function i(t) { return!e(v, t) }

        function n(t) { return t.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, "\\$&") }

        function o(t) { return String(t).replace(/[&<>"'\/]/g, function(t) { return C[t] }) }

        function s(t) { this.string = t, this.tail = t, this.pos = 0 }
        ...
        function l(e, i, n, o) {
            for (var s, a, r, h = "", c = 0, p = e.length; p > c; ++c)
                switch (s = e[c], a = s[1], s[0]) {
                case"#":
                    if (r = n.lookup(a), "object" == typeof r)
                        if ($(r))for (var f = 0, u = r.length; u > f; ++f)h += l(s[4], i, n.push(r[f]), o);
                        else r && (h += l(s[4], i, n.push(r), o));
                    else if ("function" == typeof r) {
                        var d = null == o ? null : o.slice(s[3], s[5]);
                        r = r.call(n.view, d, function(t) { return i.render(t, n) }), null != r && (h += r);
        ...
        function p(t) { return[new RegExp(n(t[0]) + "\\s*"), new RegExp("\\s*" + n(t[1]))] }

        function f(e, o) {
            function a() {
                if (T && !E)for (; x.length;)delete k[x.pop()];
                else x = [];
                T = !1, E = !1;
            }
        ...
        var u = /\s*/, d = /\s+/, v = /\S/, m = /\s*=/, g = /\s*\}/, y = /#|\^|\/|>|\{|&|=|!/, b = RegExp.prototype.test, w = Object.prototype.toString, $ = Array.isArray || function(t) { return"[object Array]" === w.call(t) }, C = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "/": "&#x2F;" };
        s.prototype.eos = function() { return"" === this.tail }, s.prototype.scan = function(t) {
            ...
            return e;
        }, a.make = function(t) { return t instanceof a ? t : new a(t) }, a.prototype.push = function(t) { return new a(t, this) }, a.prototype.lookup = function(t) {
            var e = this._cache[t];
            if (!e) {
                if ("." == t)e = this.view;
                else
        ...
        }, r.prototype.clearCache = function() { this._cache = {}, this._partialCache = {} }, r.prototype.compile = function(e, i) {
            var n = this._cache[e];
            if (!n) {
                var o = t.parse(e, i);
        ...
        }, r.prototype.getPartial = function(t) { return t in this._partialCache || !this._loadPartial || this.compilePartial(t, this._loadPartial(t)), this._partialCache[t] }, r.prototype.compileTokens = function(t, e) {
            var i = this;
            return function(n, o) {
                if (o)
                    if ("function" == typeof o)i._loadPartial = o;
                    else for (var s in o)i.compilePartial(s, o[s]);
                return l(t, i, a.make(n), e);
            };
        }, r.prototype.render = function(t, e, i) { return this.compile(t)(e, i) }, t.name = "mustache.js", t.version = "0.7.2", t.tags = ["{{", "}}"], t.Scanner = s, t.Context = a, t.Writer = r, t.parse = f, t.escape = o;
        var k = new r;
        t.clearCache = function() { return k.clearCache() }, t.compile = function(t, e) { return k.compile(t, e) }, t.compilePartial = function(t, e, i) { return k.compilePartial(t, e, i) }, t.compileTokens = function(t, e) { return k.compileTokens(t, e) }, t.render = function(t, e, i) { return k.render(t, e, i) }, t.to_html = function(e, i, n, o) {
        ...
        function i(t) {
            var i = e(t);
            return t && i && (t = "https://www.youtube.com/embed/" + e(t)), t;
        }
        ...
        function o() {
            var e, o = "", s = t("#video").is(":checked"), a = t("#youtubeAutoplay").is(":checked"), r = t("#youtubeREL").is(":checked"), l = t("#youtubeHD").is(":checked"), h = t("#youtubeWidth").val(), c = t("#youtubeHeight").val(), p = i(t("#youtubeID").val());
            return o += r ? "?rel=1" : "?rel=0", o += l ? "&hd=1" : "&hd=0", a && (o += "&autoplay=1"), p && (e = n(s, h, c, p + o)), e;
        }

        function s() { t("#preview").html(n(!0, 420, 315, i(t("#youtubeID").val()))) }

        function a(t) { clearTimeout(h), h = setTimeout(s, t || 1e3) }
        ...
        function l() { t("#preview").length && t("#youtubeID").keypress(function() { a() }).change(function() { a(100) }) }
        ...
        t(function() {
            ...
            t.get("view/forms.html", function(i) { t("#template-container").append(Mustache.render(i, e)), l(), t("#insert-btn").on("click", r) });
        });
}(jQuery);