...
namespace TinyCms.Services.Posts
{
    ...
    public static class CategoryExtensions
    {
        ...
        /// <returns>A PostCategory that has the specified values; otherwise null</returns>
        public static PostCategory FindPostCategory(this IList<PostCategory> source,
            int productId, int categoryId)
        {
            foreach (var productCategory in source)
                if (productCategory.PostId == productId && productCategory.CategoryId == categoryId)
