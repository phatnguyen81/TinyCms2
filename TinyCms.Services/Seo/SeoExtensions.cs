...
namespace TinyCms.Services.Seo
{
    public static class SeoExtensions
    {
        ...
        public static string GetSeName(this PostTag postTag, int languageId)
        {
            ...
            var seName = GetSeName(postTag.GetLocalized(x => x.Name, languageId));
            return seName;
        }
            ...
            where T : BaseEntity, ISlugSupported
        {
            ...
            while (true)
            {
                ...
                var reserved1 = urlRecord != null &&
                                !(urlRecord.EntityId == entity.Id &&
                                  urlRecord.EntityName.Equals(entityName, StringComparison.InvariantCultureIgnoreCase));
                //and it's not in the list of reserved slugs
                var reserved2 = seoSettings.ReservedUrlRecordSlugs.Contains(tempSeName,
        ...
        private static void InitializeSeoCharacterTable()
        {
            lock (s_lock)
            {
                if (_seoCharacterTable == null)
                {
                    ...
                    _seoCharacterTable.Add(ToUnichar("00D0"), "D");
                    ...
                    _seoCharacterTable.Add(ToUnichar("00DE"), "Th");
                    ...
                    _seoCharacterTable.Add(ToUnichar("00F0"), "d");
                    ...
                    _seoCharacterTable.Add(ToUnichar("00FE"), "th");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0110"), "D");
                        // LATIN CAPITAL LETTER D WITH STROKE -- no decomposition                     // Capital D with stroke
                    _seoCharacterTable.Add(ToUnichar("0111"), "d");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0126"), "H");
                        // LATIN CAPITAL LETTER H WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0127"), "h");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0141"), "L");
                        // LATIN CAPITAL LETTER L WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0142"), "l");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0149"), "'n");
                        // LATIN SMALL LETTER N PRECEDED BY APOSTROPHE                              ;
                    _seoCharacterTable.Add(ToUnichar("014A"), "NG");
                        // LATIN CAPITAL LETTER ENG -- no decomposition                             ;
                    _seoCharacterTable.Add(ToUnichar("014B"), "ng");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0166"), "T");
                        // LATIN CAPITAL LETTER T WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0167"), "t");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0180"), "b");
                        // LATIN SMALL LETTER B WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0181"), "B");
                        // LATIN CAPITAL LETTER B WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0182"), "B");
                        // LATIN CAPITAL LETTER B WITH TOPBAR -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0183"), "b");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0191"), "F");
                        // LATIN CAPITAL LETTER F WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0192"), "f");
                        // LATIN SMALL LETTER F WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0193"), "G");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0197"), "I");
                        // LATIN CAPITAL LETTER I WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0198"), "K");
                        // LATIN CAPITAL LETTER K WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0199"), "k");
                    ...
                    _seoCharacterTable.Add(ToUnichar("019B"), "l");
                    ...
                    _seoCharacterTable.Add(ToUnichar("019D"), "N");
                        // LATIN CAPITAL LETTER N WITH LEFT HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("019E"), "n");
                        // LATIN SMALL LETTER N WITH LONG RIGHT LEG -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("019F"), "O");
                    ...
                    _seoCharacterTable.Add(ToUnichar("01A4"), "P");
                        // LATIN CAPITAL LETTER P WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01A5"), "p");
                    ...
                    _seoCharacterTable.Add(ToUnichar("01B8"), "Z");
                        // LATIN CAPITAL LETTER EZH REVERSED -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01B9"), "Z");
                        // LATIN SMALL LETTER EZH REVERSED -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01BA"), "z");
                    ...
                    _seoCharacterTable.Add(ToUnichar("01BC"), "5");
                    ...
                    _seoCharacterTable.Add(ToUnichar("01C5"), "DZ");
                    ...
                    _seoCharacterTable.Add(ToUnichar("01E4"), "G");
                        // LATIN CAPITAL LETTER G WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01E5"), "g");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0220"), "N");
                        // LATIN CAPITAL LETTER N WITH LONG RIGHT LEG -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0221"), "d");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0224"), "Z");
                        // LATIN CAPITAL LETTER Z WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0225"), "z");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0234"), "l");
                        // LATIN SMALL LETTER L WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0235"), "n");
                        // LATIN SMALL LETTER N WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0236"), "t");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0252"), "a");
                        // LATIN SMALL LETTER TURNED ALPHA -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0253"), "b");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0255"), "c");
                        // LATIN SMALL LETTER C WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0256"), "d");
                        // LATIN SMALL LETTER D WITH TAIL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0257"), "d");
                    ...
                    _seoCharacterTable.Add(ToUnichar("025A"), "e");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0266"), "h");
                        // LATIN SMALL LETTER H WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0267"), "h");
                        // LATIN SMALL LETTER HENG WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0268"), "i");
                    ...
                    _seoCharacterTable.Add(ToUnichar("026B"), "l");
                        // LATIN SMALL LETTER L WITH MIDDLE TILDE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("026C"), "l");
                        // LATIN SMALL LETTER L WITH BELT -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("026D"), "l");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0276"), "OE");
                        // LATIN LETTER SMALL CAPITAL OE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0277"), "o");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0281"), "r");
                        // LATIN LETTER SMALL CAPITAL INVERTED R -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0282"), "s");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0288"), "t");
                    ...
                    _seoCharacterTable.Add(ToUnichar("028B"), "u");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0290"), "z");
                        // LATIN SMALL LETTER Z WITH RETROFLEX HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0291"), "z");
                    ...
                    _seoCharacterTable.Add(ToUnichar("0293"), "z");
                    ...
                    _seoCharacterTable.Add(ToUnichar("029A"), "e");
                        // LATIN SMALL LETTER CLOSED OPEN E -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("029B"), "G");
                    ...
                    _seoCharacterTable.Add(ToUnichar("029D"), "j");
                    ...
                    _seoCharacterTable.Add(ToUnichar("02A0"), "q");
                    ...
                    _seoCharacterTable.Add(ToUnichar("02A3"), "dz");
                        // LATIN SMALL LETTER DZ DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A4"), "dz");
                        // LATIN SMALL LETTER DEZH DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A5"), "dz");
                        // LATIN SMALL LETTER DZ DIGRAPH WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A6"), "ts");
                        // LATIN SMALL LETTER TS DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A7"), "ts");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D01"), "AE");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D03"), "B");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D06"), "TH");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D08"), "e");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D0C"), "L");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D0E"), "N");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D10"), "O");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D12"), "o");
                        // LATIN SMALL LETTER SIDEWAYS OPEN O -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D13"), "o");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D15"), "ou");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D17"), "o");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D19"), "R");
                        // LATIN LETTER SMALL CAPITAL REVERSED R -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D1A"), "R");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D1E"), "u");
                        // LATIN SMALL LETTER SIDEWAYS DIAERESIZED U -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D1F"), "m");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D23"), "EZH");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D2F"), "B");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D3B"), "N");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D4E"), "i");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1E68"), "S");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1EA8"), "A");
                        // LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND HOOK ABOVE
                    _seoCharacterTable.Add(ToUnichar("1EA9"), "a");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1EAC"), "A");
                        // LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND DOT BELOW
                    _seoCharacterTable.Add(ToUnichar("1EAD"), "a");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1EC2"), "E");
                        // LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND HOOK ABOVE
                    _seoCharacterTable.Add(ToUnichar("1EC3"), "e");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1EC6"), "E");
                        // LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND DOT BELOW
                    _seoCharacterTable.Add(ToUnichar("1EC7"), "e");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1ED4"), "O");
                        // LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND HOOK ABOVE
                    _seoCharacterTable.Add(ToUnichar("1ED5"), "o");
                    ...
                    _seoCharacterTable.Add(ToUnichar("1ED8"), "O");
                        // LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND DOT BELOW
                    _seoCharacterTable.Add(ToUnichar("1ED9"), "o");
